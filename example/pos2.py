...
os.chdir('/run/user/1000/gvfs/smb-share:server=10.6.148.41,share=eth/break_con2/DEM')
top=read.read_ave('./ave_force_top.txt')
ke=read.read_ave('./KE.txt')
...
# plt.legend([l1,l2],labels=['Unbreakable','breakable'],loc='lower left')
...
# plt.xlabel('TimeStep')
plt.ylabel('Topmesh Position',fontlabel)
# plt.legend([l3,l4],labels=['Unbreakable','breakable'],loc='lower left')
...
# plt.xlabel('TimeStep')
plt.ylabel('Kinetic Energy',fontlabel)
# plt.legend([l5,l6],labels=['Unbreakable','breakable'],loc='upper left')
...
os.chdir('/run/user/1000/gvfs/smb-share:server=10.6.148.41,share=eth/break_loss2/DEM')
top=read.read_ave('./ave_force_top.txt')
ke=read.read_ave('./KE.txt')
number=read.read_log_thermo('./log.liggghts')
...
# plt.xlabel('TimeStep')
plt.ylabel('Friciton ratio',fontlabel)
plt.legend([l11,l12,l13],labels=['Unbreakable','Breakable','Breakable with mass loss'],loc='lower left',prop=font1)
...
# plt.xlabel('TimeStep')
plt.ylabel('Topmesh Position',fontlabel)
plt.legend([l21,l22,l23],labels=['Unbreakable','Breakable','Breakable with mass loss'],loc='lower left',prop=font1)
...
# plt.xlabel('TimeStep')
plt.ylabel('Kinetic Energy',fontlabel)
plt.legend([l31,l32,l33],labels=['Unbreakable','Breakable','Breakable with mass loss'],loc='upper left',prop=font1)
...
fig = plt.gcf()
fig.savefig('../../FIG/fig2.png',dpi=300)
